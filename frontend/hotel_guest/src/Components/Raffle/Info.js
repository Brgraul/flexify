...
export default props => {
    const checkInTime = new Date(props.reservation.check_in);
    const checkOutTime = new Date(props.reservation.check_out);
    ...
    return(
        <Grid container item xs = {12} style={{marginBottom:"5%"}}>
            ...
            <Grid item xs = {12}>
                <Header>{props.reservation.property} {props.reservation.address.street}</Header>
            </Grid>
